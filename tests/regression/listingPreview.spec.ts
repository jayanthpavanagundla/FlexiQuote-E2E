...
test.describe('Listing Preview', () => {
    ...
    test('Repairer Quote Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.verifyPdfLoadedAndNoError('rptQuoteAnalysis', SUBREPORT_ERROR);
    });
    ...
    test('Misc Quote Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptMiscQuoteListV2', SUBREPORT_ERROR);
    });
    ...
    test('Quick Invoice Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptDebtorQuickInvoice', SUBREPORT_ERROR);
    });
    ...
    test('Debtor Adjustment Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptDebtorAdjustment', SUBREPORT_ERROR);
    });
    ...
    test('Receipt Entry Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('RPTDEBTORRECEIPTENTRY', SUBREPORT_ERROR);
    });
    ...
    test('Sundry Creditor Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptCreditorSundryCreditor', SUBREPORT_ERROR);
    });
    ...
    test('Payment Entry Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptCreditorPaymentEntryListV2', SUBREPORT_ERROR);  
    });
    ...
    test('Purchase Order Listing Preview', async ({ page }) => {        
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('AT_CreditorPurchaseOrderListV2', SUBREPORT_ERROR);
    });
    ...
    test('Return Parts Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('RPTCREDITORRETURNPARTS', SUBREPORT_ERROR);
    });
    ...
    test('Due In & Due Out Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptProductionInOut', SUBREPORT_ERROR);
    });
    ...
    test('Job Invoiced Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptJobInvoiced', SUBREPORT_ERROR);
    });
    ...
    test('Outstanding Parts Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('AT_OutStandingParts', SUBREPORT_ERROR);  
    });
    ...
    test('Outstanding Credits Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('AT_OutstandingCredits', SUBREPORT_ERROR);  
    });
    ...
    test('Sales Analysis Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptSalesList', SUBREPORT_ERROR);  
    });
    ...
    test('Debtor List Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('AT_DebtorListV2', SUBREPORT_ERROR);  
    });
    ...
    test('Receipts Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptReceiptListV2', SUBREPORT_ERROR);  
    });
    ...
    test('Creditor List Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('AT_CreditorListV2', SUBREPORT_ERROR);  
    });
    ...
    test('Payment List Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('AT_PaymentListV2', SUBREPORT_ERROR);  
    });
    ...
    test('Insurer Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptInsurerList', SUBREPORT_ERROR);  
    });
    ...
    test('Customer Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptCustomerList', SUBREPORT_ERROR);  
    });
    ...
    test('Vendor Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptVendorList', SUBREPORT_ERROR);  
    });
    ...
    test('Contact Profile Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptTablesContactProfile', SUBREPORT_ERROR);  
    });
    ...
    test('Recurring Remarks Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptRemarkList', SUBREPORT_ERROR);  
    });
    ...
    test('Quick Item Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptQuickItemListV2', SUBREPORT_ERROR);  
    });
    ...
    test('Item Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptItemList', SUBREPORT_ERROR);  
    });
    ...
    test('Other Labour Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptOtherLabourTablemaintenance', SUBREPORT_ERROR);  
    });
    ...
    test('Vehicle Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptTablesCar', SUBREPORT_ERROR);  
    });
    ...
    test('Unscheduled Model Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptTableUnscheduleModelLists', SUBREPORT_ERROR);
    });
    ...
    test('G/L Mapping Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptAdminAccountGLMapping', SUBREPORT_ERROR);
    });
    ...
    test('Email/SMS Log Listing Preview', async ({ page }) => {
        ...
        await subNavBarPage.openPreview();
        await subNavBarPage.verifyPrintPreviewTitle();
        await subNavBarPage.verifyPdfLoadedAndNoError('rptEmailSmsList', SUBREPORT_ERROR);
    });
